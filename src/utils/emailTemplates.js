...
const passwordResetEmailTemplate = (code) => ({
  subject: 'KMSF — Reset Your Password',
  html: `
    <!DOCTYPE html>
    <html lang="en">
    <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <body>
    <div class="container">
      <div class="header"><h1>KMSF Password Reset</h1></div>
      <div class="body">
        <h2 style="color:#15314b;">Reset Your Password</h2>
        <p>You recently requested to reset your password for your KMSF account. Use the code below to complete the reset process. This code is valid for 10 minutes.</p>
        <div class="code">${code}</div>
