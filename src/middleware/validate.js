...
const validateUpdateMember = [
    ...
    body('gender').optional().isIn(['Male', 'Female', 'Other', 'Non-binary', 'Prefer not to say']).withMessage('Invalid gender.'),
    body('organization').optional().isIn(['KSA', 'KuMA', 'Student', 'Students']).withMessage('Invalid organization.'),
